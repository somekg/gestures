...
def draw_landmarks_on_image(rgb_image, detection_result, allowed_hands=["Left", "Right"]):
    """Draws the hand skeleton, filtering by allowed hands."""
    ...
    for idx, hand_landmarks in enumerate(detection_result.hand_landmarks): 
        ...
        # Check against our dynamic rule
        if hand_label not in allowed_hands:
            continue  
